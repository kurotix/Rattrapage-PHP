...
<body>
	...
	<div class="a">
		<h2>Modifier nom du Groupe</h2>
			
			<form method="post" action="..\controleur\form_modifiergroupe.php">
				<p>NomGroupe a modifié :</p>
				<p><input type="text" name="ancienGrp"></p>

				<p>New NomGroupe :</p>
				<p><input type="text" name="newGrp"></p>
